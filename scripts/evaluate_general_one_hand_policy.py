...
def reward_config_from_profile(profile: str) -> GeneralRewardConfig:
    ...
    if profile == "transition_cleanup_release_completion_v2":
        return GeneralRewardConfig(
            target_travel_weight=4.0,
            wrong_travel_weight=0.15,
            wrong_pressed_weight=0.20,
            ...
            early_activation_weight=0.50,
            duration_weight=0.25,
            release_completion_release_weight=1.25,
            release_completion_bonus=1.50,
        )
    if profile == "transition_cleanup_release_completion_motion_v2":
        return GeneralRewardConfig(
            target_travel_weight=4.0,
            wrong_travel_weight=0.15,
            wrong_pressed_weight=0.20,
            ...
            release_completion_release_weight=1.25,
            release_completion_bonus=1.50,
            transition_action_rate_weight=0.05,
            transition_saturation_weight=0.03,
            transition_saturation_threshold=0.95,
        )
